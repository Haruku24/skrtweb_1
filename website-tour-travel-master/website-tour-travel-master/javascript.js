...
document.querySelector('.nav-button.right').addEventListener('click', function() {
    // Logic for sliding right
});

// Open transaksi.html in a new tab
document.getElementById('pesanTiket').addEventListener('click', function() {
    window.open('transaksi.html', '_blank');
});
